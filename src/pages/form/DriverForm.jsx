              ...
              {error && (
                <div className="bg-red-50 border border-red-200 rounded-md p-3 mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-red-800"><strong>Error:</strong> {error}</span>
                  </div>
                </div>
              )}
                  ...
                  <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                    ...
                    <div className="p-4 space-y-3">
                      ...
                      <div className="pt-2 border-t border-gray-100">
                        <div className={`p-3 rounded-md text-center ${form.status === 'aktif' ? 'bg-green-50 border border-green-200' : 'bg-gray-50 border border-gray-200'}`}>
                          <div className={`text-2xl mb-1 ${form.status === 'aktif' ? 'text-green-600' : 'text-gray-400'}`}>
                            {form.status === 'aktif' ? '✓' : '○'}
                          </div>
                          <p className={`text-xs font-semibold ${form.status === 'aktif' ? 'text-green-700' : 'text-gray-600'}`}>
