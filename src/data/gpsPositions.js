...
export const generateGpsPositions = () => {
  ...
  const baseCoordinates = [
    { lat: -3.52, lon: 115.58 }, // Truck Alpha
    { lat: -3.53, lon: 115.59 }, // Truck Beta
    { lat: -3.54, lon: 115.6 }, // Truck Gamma
    { lat: -3.55, lon: 115.61 }, // Truck Delta
    { lat: -3.56, lon: 115.62 }, // Truck Epsilon
    { lat: -3.57, lon: 115.63 }, // Truck Zeta
    { lat: -3.58, lon: 115.64 }, // Truck Eta
    { lat: -3.59, lon: 115.65 }, // Truck Theta
  ];
