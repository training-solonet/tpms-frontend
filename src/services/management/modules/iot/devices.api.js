...
export const devicesApi = {
  ...
  getSensorById: async (sensorId) => {
    const response = await api2Instance.get(`/iot/sensors/${parseInt(sensorId)}`);
    return response;
  },
  ...
  getSensorsByDevice: async (deviceId) => {
    const response = await api2Instance.get(`/iot/devices/${parseInt(deviceId)}/sensors`);
    return response;
  },
  ...
  createSensor: async (sensorData) => {
    ...
    const response = await api2Instance.post('/iot/sensors', payload);
    return response;
  },
  ...
  updateSensor: async (sensorId, sensorData) => {
    ...
    const response = await api2Instance.put(`/iot/sensors/${parseInt(sensorId)}`, payload);
    return response;
  },
  ...
  deleteSensor: async (sensorId) => {
    const response = await api2Instance.delete(`/iot/sensors/${parseInt(sensorId)}`);
    return response;
  },
};
